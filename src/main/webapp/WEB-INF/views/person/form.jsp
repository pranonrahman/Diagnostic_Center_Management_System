    ...
    <div class="w-50 mx-auto">
        ...
        <form:form action="/person/createOrUpdate" method="POST" modelAttribute="person">
            <div class="mb-3">
                ...
                <form:input readonly="${readOnly}" path="userName" type="text" value="${person.userName}" cssClass="form-control"/>
            ...
            <div class="mb-3">
                ...
                <form:input readonly="${readOnly}" path="name" type="text" value="${person.name}" cssClass="form-control"/>
                <form:errors path="name" cssClass="invalid-feedback d-block"/>
            </div>

            <div class="mb-3">
                <form:label path="phone" cssClass="form-label">Phone</form:label>
                <form:input readonly="${readOnly}" path="phone" type="text" maxlength="11" value="${person.phone}" cssClass="form-control"/>
                <form:errors path="phone" cssClass="invalid-feedback d-block"/>
            </div>

            <div class="mb-3">
                <form:label path="email" cssClass="form-label">Email</form:label>
                <form:input readonly="${readOnly}" path="email" type="email" value="${person.email}" cssClass="form-control"/>
            ...
            <div class="mb-3">
                ...
                <c:forEach var="gender"  items="${genderList}">
                    <div class="form-check" >
                        <form:radiobutton disabled="${readOnly}" cssClass="form-check-input" value="${gender}" path="gender"/>
            ...
            <div class="mb-3">
                <c:choose>
                    <c:when test="${not readOnly}">
                            ...
                            <form:input path="dateOfBirth" type="date" value="<fmt:formatDate>" cssClass="form-control"/>
                            <form:errors path="dateOfBirth" cssClass="invalid-feedback d-block"/>
                    </c:when>
                    <c:when test="${not empty person.dateOfBirth}">
                        <form:label path="dateOfBirth">Date of birth</form:label>
                        <input type="text" disabled="disabled" class="form-control" value="<fmt:formatDate value="${person.dateOfBirth}"/>">
                    </c:when>
                </c:choose>
            </div>
            <c:if test="${not readOnly}">
